package az.company.auth.error;

import az.company.auth.error.exception.AuthException;
import az.company.auth.error.exception.CommonException;
import az.company.auth.error.exception.InvalidInputException;
import az.company.auth.error.exception.NotFoundException;
import az.company.auth.error.model.ErrorResponse;
import az.company.auth.util.MessageSourceUtil;
import az.company.auth.util.WebUtil;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ErrorResponse handleAuthenticationException(AuthenticationException ex) {
        this.addErrorLog(HttpStatus.UNAUTHORIZED, ex.getMessage(), "AuthenticationException");
        return new ErrorResponse(this.webUtil.getRequestId(), HttpStatus.UNAUTHORIZED, ex.getMessage());
    }
    ...
    public ErrorResponse handleAccessDeniedException(AccessDeniedException ex) {
        ...
        return new ErrorResponse(this.webUtil.getRequestId(), HttpStatus.FORBIDDEN, ex.getMessage());
    }
    ...
    public ErrorResponse handleBadCredentialsException(BadCredentialsException ex) {
        String message = this.messageSourceUtil.getMessage(ex.getMessage());
        this.addErrorLog(HttpStatus.FORBIDDEN.value(), message, "BadCredentialsException");
        return new ErrorResponse(this.webUtil.getRequestId(), HttpStatus.FORBIDDEN.value(), message);
    }

    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ExceptionHandler({AuthException.class})
    public ErrorResponse handleCommonAuthException(AuthException ex) {
        String message = this.messageSourceUtil.getMessage(ex.getMessage());
        this.addErrorLog(HttpStatus.UNAUTHORIZED, message, "CommonAuthException");
        return new ErrorResponse(this.webUtil.getRequestId(), HttpStatus.UNAUTHORIZED, message);
    }
